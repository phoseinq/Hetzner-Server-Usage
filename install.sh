...
echo "🧰 Installing the 'hetzner' management command..."
install -m 755 "$DIR/hetzner-bot.sh" /usr/local/bin/hetzner
...
echo "    hetzner              # menu"
echo "    hetzner update       # or: start|stop|restart|status|logs|env"
